<p align="center">
    ...
    <br/>
    <img src="https://img.shields.io/badge/version-1.5.4-brightgreen.svg?style=flat-square" alt="Version">
...
Based on https://github.com/xchwarze/samsung-tv-api work - this fork was made to use samsung-tv-ws-api with https://github.com/WebThingsIO/gateway-addon-python

## Install

```bash
$ pip3 install git+https://github.com/jacksga/samsung-tv-ws-api.git
```
or...!
```bash
$ git clone https://github.com/jacksga/samsung-tv-ws-api
